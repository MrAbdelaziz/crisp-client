...
(function() {
    try {
        ...
        i.prototype.init = function() {
            var i, n, s = this, e = "init";
            try {
                this.n && !0 !== this.s && (this.s = !0,
                ...
                function t() {
                    s.f = setTimeout(function() {
                        s.f = null,
                        s.y -= s.w,
                        void 0 !== window[s.v] && "function" == typeof window[s.v].__init && !0 === n() ? (s.x.info(s.ns + "." + e, "Dependencies loaded"),
        ...
        i.prototype.reset = function() {
            try {
                null !== this.f && clearTimeout(this.f),
                this.u_(),
                this.init()
            } catch (t) {}
        }
        ...
        i.prototype.d_ = function() {
            try {
                this.f_("dns-prefetch", this.ms),
                this.f_("preconnect", this._e),
                this.l_(),
                this.p_()
            } catch (t) {}
        }
        ...
        i.prototype.I_ = function() {
            ...
            this.n_ = document.location.href,
            this.s_ = document.location.hostname,
            this.e_ = window.navigator.userAgent,
            this.o_ = (new Date).getTimezoneOffset(),
            this.c_ = this.S_(),
            "string" == typeof CRISP_WEBSITE_ID && CRISP_WEBSITE_ID ? this.n = CRISP_WEBSITE_ID : this.n = this.g_(),
            "string" == typeof CRISP_TOKEN_ID && CRISP_TOKEN_ID ? this.t_ = CRISP_TOKEN_ID : "number" == typeof CRISP_TOKEN_ID && CRISP_TOKEN_ID ? this.t_ = CRISP_TOKEN_ID.toString() : this.t_ = null,
            "number" == typeof CRISP_COOKIE_EXPIRE && 0 < CRISP_COOKIE_EXPIRE ? this.Fn = CRISP_COOKIE_EXPIRE : this.Fn = null,
            "string" == typeof CRISP_COOKIE_DOMAIN && CRISP_COOKIE_DOMAIN ? this.i_ = CRISP_COOKIE_DOMAIN : this.i_ = null,
            "function" == typeof CRISP_READY_TRIGGER ? this.h_ = CRISP_READY_TRIGGER : this.h_ = {},
            "object" === ("undefined" == typeof CRISP_RUNTIME_CONFIG ? "undefined" : t(CRISP_RUNTIME_CONFIG)) ? this.a_ = CRISP_RUNTIME_CONFIG : this.a_ = {},
            "object" === ("undefined" == typeof CRISP_INCLUDE_ATTRS ? "undefined" : t(CRISP_INCLUDE_ATTRS)) ? this.E_ = CRISP_INCLUDE_ATTRS : this.E_ = {}
        }
        ,
        i.prototype.v_ = function() {
            try {
                this.r_ = [],
                "function" == typeof window.MutationObserver && "function" == typeof JSON.stringify && this.r_.push("browsing"),
                ("function" == typeof window.RTCPeerConnection && "object" === t(navigator.mediaDevices) && "https:" === document.location.protocol && (window.innerWidth || 0) >= this.b_ && (window.innerHeight || 0) >= this.P_ || !0 === this.T_) && this.r_.push("call")
            } catch (t) {}
        }
        ,
        i.prototype.C_ = function() {
            var t;
            try {
                this.a_.locale && (-1 !== (t = this.c_.indexOf(this.a_.locale)) && this.c_.splice(t, 1),
                this.c_.unshift(this.a_.locale))
            } catch (t) {}
        }
        ,
        i.prototype.__ = function(t) {
            try {
                for (var i in this.E_)
                    this.E_.hasOwnProperty(i) && t.setAttribute(i, this.E_[i])
            } catch (t) {}
        }
        ,
        ...
        i.prototype.K_ = function() {
            var t, i, n = !1;
            try {
                !0 === navigator.cookieEnabled ? n = !0 : window.localStorage && "function" == typeof window.localStorage.setItem && "function" == typeof window.localStorage.getItem && "function" == typeof window.localStorage.removeItem && (t = "" + (new Date).getTime(),
    ...
    function i() {
        ...
        try {
            ...
            this.U_ = "client.crisp.chat",
            this.x_ = "client.relay.crisp.chat",
            ...
            this.ms = this.L_ + "//" + this.x_,
            this.ws = this.L_ + "//" + this.B_,
            this._e = this.L_ + "//" + this.U_,
            this.io = [{
            ...
            this.y_ = "static/javascripts",
            this.w_ = "static/stylesheets",
            this.v = "$__CRISP_INSTANCE",
            this.M_ = "$__CRISP_INCLUDED",
            this.w = 100,
            this.R_ = 3e4,
            this.F_ = 1e3,
            this.k_ = 280,
            ...
            this.u_(),
            !0 === window[this.M_] || void 0 !== window[this.v] && "function" == typeof window[this.v].__init || !0 !== this.N_() || (window[this.M_] = !0,
